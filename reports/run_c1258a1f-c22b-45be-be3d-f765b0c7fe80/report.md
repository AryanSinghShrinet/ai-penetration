# Bug Bounty Report — Run c1258a1f-c22b-45be-be3d-f765b0c7fe80
...
### idor
- Status: **PLANNED** | Payload: `IDOR swap 5 <-> 2`
### sqli
- Status: **PLANNED** | Payload: `1; SELECT SLEEP(2)--`
### file_upload
- Status: **PLANNED** | Payload: `probe-file_upload`
### cmd_injection
- Status: **PLANNED** | Payload: ``cat /etc/passwd``
### xss
- Status: **PLANNED** | Payload: `<svg onload=alert(1)>`
### cors
